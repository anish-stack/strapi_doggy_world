        ...
        const fetchData = async () => {
            try {
                ...
                const [
                    ...
                    axios.get('http://192.168.1.3/api/lab-tests?populate=*'),
                    axios.get('http://192.168.1.3/api/lab-tests?populate=*&filters[common_disease_dog][$eq]=true&filters[isPopular][$eq]=false'),
                    axios.get('http://192.168.1.3/api/lab-tests?populate=*&filters[common_disease_cat][$eq]=true&filters[isPopular][$eq]=false'),
                    axios.get('http://192.168.1.3/api/lab-tests?populate=*&filters[is_available_at_main_branch][$eq]=true'),
                    axios.get('http://192.168.1.3/api/lab-tests?populate=*&filters[isPopular][$eq]=true'),
                ]);
