...
export default function GroomReview({ open, close, appointment, isGrooming }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.1.3/api/rate_Service', {
                id: appointment.id,
                rate: selectedRating,
                        ...
                        <>
                            <View style={styles.header}>
                                ...
                                <Text style={styles.subtitle}>
                                    Grooming {appointment?.Type || "Consultation"} with Doggy world Care
                                </Text>
                            </View>
